...
const index = () => {
  ...
  return (
    ...
    <div className={`mt-18 ${appearance && contentArea && targeting && settings ? "" : "opacity-60 bg-red"}`}>
          ...
          <input type="text" className="w-full border border-deneme hover:border-primary focus:border-primary text-black text-sm font-secondary font-normal rounded-lg px-[9px] py-3 mb-3" placeholder="Your Webhook URL" value="" required disabled={!settings}/>
          ...
          <button className='btn px-8 py-[19px] text-lg font-primary tracking-wide mb-6' disabled={!settings}>Get your Code</button>
