  ...
  return (
        ...
        <>
          ...
          <form className="mb-3" action='POST'>
            <input type="text" className="w-full border border-deneme hover:border-primary focus:border-primary text-black placeholder-black text-sm font-secondary font-normal rounded-lg px-[9px] py-3 mb-3" placeholder="Sign Up" required />
            <input type="text" className="w-full border border-deneme hover:border-primary focus:border-primary text-black placeholder-black text-sm font-secondary font-normal rounded-lg px-[9px] py-3 mb-3" placeholder="Enter your email" required />
            <input type="text" className="w-full border border-deneme hover:border-primary focus:border-primary text-black placeholder-black text-sm font-secondary font-normal rounded-lg px-[9px] py-3 mb-3" placeholder="Sign Up" required />
            <input type="text" className="w-full border border-deneme hover:border-primary focus:border-primary text-black placeholder-black text-sm font-secondary font-normal rounded-lg px-[9px] py-3 mb-6" placeholder="By singning up, you agree to Privacy Policy" required />
            <div className="">
