...
const index = () => {
  return (
          ...
          <div className="flex flex-col w-[480px] h-[285px] bg-white justify-center items-bottom px-16 relative text-center border border-[#EAEAEA] shadow-xl rounded-xl">
            ...
            <div className="grid grid-rows-1 w-full">
                <button className='bg-[#7D4AEA] font-secondary font-medium text-white text-base py-3.5 rounded-lg'>Go to dashboard</button>
            </div>
