...
const index = () => {
  const { title, subtitle, button1, button2, textColor, buttonColor, borderColor, backgroundColor } = useModalCustomizationContext();

  return (
            <div className="flex flex-col px-16 py-8 justify-center items-center text-center relative border shadow-xl rounded-xl w-[480px]" style={{ backgroundColor, borderColor }}>
