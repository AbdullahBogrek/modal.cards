...
const index = () => {
  return (
            <div className="flex flex-col w-[480px] h-[752px] bg-white relative border border-generator-gray shadow-xl rounded-xl">
