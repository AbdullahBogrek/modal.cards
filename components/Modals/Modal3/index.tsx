...
const index = () => {
  return (
          ...
          <div className="flex flex-col w-[480px] h-[550px] bg-white justify-center items-center relative border border-[#EAEAEA] shadow-xl rounded-xl">

            <h5 className='font-secondary font-medium text-[#7D4AEA] text-lg mb-3'>PLANS</h5>
            ...
            <div className="inline-flex flex-col mb-8 w-full px-16">
                <div className="flex flex-row items-center">
                    <input id="default-radio-1" type="radio" value="" name="default-radio" className="w-6 h-6 text-white bg-[#7D4AEA] border-[#777777] focus:ring-red"/>
            ...
            <div className="grid grid-cols-2 gap-5 w-full px-16">
              <button className='outline outline-offset-0 outline-1 outline-[#EAEAEA] bg-white hover:bg-[#EAEAEA] font-secondary font-medium text-black text-base py-3.5 rounded-lg'>Cancel</button>
