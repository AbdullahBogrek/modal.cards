...
const index = () => {
  const { title, subtitle, inputPlaceholder1, button2, linkText2, textColor, buttonColor, placeholderColor, borderColor, backgroundColor } = useModalCustomizationContext();
  ...
  return (
          <div className="flex flex-col justify-center items-center px-16 py-8 relative text-center border shadow-xl rounded-xl w-[480px]" style={{ backgroundColor, borderColor }}>
            ...
            <div className="bg-none mb-3">
                <svg width="120" height="130" viewBox="0 0 160 173" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M109.239 51.3849H51.2216C36.8536 51.3849 25.0977 58.8139 25.0977 67.8929V116.775H92.1487V70.3159C92.1487 61.6869 101.872 54.6259 113.756 54.6259C125.64 54.6259 135.362 61.5489 135.362 70.0109V67.5719C135.363 58.6689 123.607 51.3849 109.239 51.3849Z" fill={buttonColor}/>
                    <path d="M83.1157 116.775H73.0156V172.549H87.4396V116.775H83.1157Z" fill="#FFC300"/>
                    <path d="M85.8509 27.2029H71.2549V36.6409H85.8509V27.2029Z" fill={buttonColor}/>
            ...
            <h4 className='font-secondary font-normal text-xl mb-9' style={{ color: textColor }}>{subtitle}</h4>
