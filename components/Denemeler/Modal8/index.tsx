    ...
    <div className='px-5 xl:px-0 mt-18'>
      ...
      <div className="mt-6 flex flex-col lg:flex-row justify-center">
        ...
        <div className="bg-red w-full lg:w-2/3">
            <div className="flex flex-col w-[740px] h-[400px] bg-primary justify-center items-bottom relative text-center rounded-xl">
                ...
                <div className="px-48">
                    ...
                    <div className="grid grid-cols-2 gap-5 w-full">
                        ...
                        <button className='bg-white font-secondary font-medium text-black text-base py-3.5 rounded-lg'>Sign up now</button>
                    </div>
                </div>
